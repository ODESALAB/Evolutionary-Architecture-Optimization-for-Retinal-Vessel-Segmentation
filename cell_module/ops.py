...
OPS = {
    'a': lambda in_c, out_c: nn.Identity(), # skip_connect
    'b' : lambda in_c, out_c: Conv2D(in_c, out_c, 1), # conv_2d_1x1
    'c' : lambda in_c, out_c: Conv2D(in_c, out_c, 3), # conv_2d_3x3
    'd' : lambda in_c, out_c: Conv2D(in_c, out_c, 5), # conv_2d_5x5
    'e' : lambda in_c, out_c: Conv2D(in_c, out_c, 7), # conv_2d_7x7
    'f': lambda in_c, out_c: SepConv2D(in_c, out_c, 3, 'same'), # sep_conv_3x3
    'g': lambda in_c, out_c: SepConv2D(in_c, out_c, 5, 'same'), # sep_conv_5x5
    'h': lambda in_c, out_c: SepConv2D(in_c, out_c, 7, 'same'), # sep_conv_7x7
    'i': lambda in_c, out_c: DilConv2D(in_c, out_c, 3, 2), # dil_conv_3x3
    'j': lambda in_c, out_c: DilConv2D(in_c, out_c, 5, 2), # dil_conv_5x5
    'k': lambda in_c, out_c: DilConv2D(in_c, out_c, 7, 2), # dil_conv_7x7
    'l': lambda in_c, out_c: ASymmetricConv(in_c, out_c, 3), # asym_conv_3x3
    'm': lambda in_c, out_c: ASymmetricConv(in_c, out_c, 5), # asym_conv_5x5
    'n': lambda in_c, out_c: ASymmetricConv(in_c, out_c, 7), # asym_conv_7x7
    "o": None,
